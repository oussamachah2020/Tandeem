import {Category, JobLevel, PaymentMethod, Role, SubCategory} from "@prisma/client";
...
const staticValues = {
    ...
    confirmation: {
        ...
        adminResetPassword: 'Le mot de passe sera réinitialisé et un email sera envoyé à l\'adresse de l\'administrateur concerné.',
        adminSuspendAccount: 'Le compte de cet administrateur sera suspendu, il ne pourra pas se connecter. Vous pourrez le réactiver à tout moment.',
        adminReactivateAccount: 'le compte de cet administrateur sera réactivé.',
        adminDelete: 'Cet administrateur sera supprimé, il perdra l\'accès à la plateforme.',
        customerDelete: "Ces ressources seront également supprimées si vous supprimez ce client:\n- Offres ajoutées par ce client.\n- Publications ajoutées par ce client.\n- Salariés de ce client, et leurs comptes tandeem.\n- Comptes administrateur liés à ce client.",
        partnerDelete: "Si vous supprimez ce partenaire, ses offres seront également supprimées.",
        offerLevel1Disable: "La désactivation de cette offre la rendra indisponible à tous les clients, y compris ceux qui l'ont déjà acceptée.",
        offerLevel1Enable: 'L\'activation cette offre la rendra immédiatement disponible à tous les clients.',
        offerLeve1Delete: "Êtes-vous sûr de vouloir supprimer cette offre ?",
        ideaBoxArchive: 'Si vous archivez cette idée, elle ne vous apparaîtra plus, elle sera cependant toujours disponible pour le salarié.',
        mediaDelete: 'Êtes-vous sûr de vouloir supprimer ce média de la bibliothèque ?'
    },
    tooltip: {
        adminResetPassword: 'Réinitialisé le mot de passe du compte de cet administrateur',
        ...
        customerUpdateCategory: 'Si vous changez la catégorie, toutes les offres associées à ce client se verront attribuer une catégorie \'N/A\'',
        customerAccountEmail: 'L\'email du compte admin de ce client.',
        partnerUpdateCategory: 'Si vous changez la catégorie, toutes les offres associées à ce partenaire se verront attribuer une catégorie \'N/A\'',
        offerDisable: 'Désactiver l\'offre',
        offerEnable: 'Activer l\'offre',
        sixteenByNineAspectRatio: 'Pour un meilleur affichage, veuillez fournir une image au format 16/9 ou 16/10 (par exemple 1920x1080 ou 1920x1200).'
    },
    notification: {
        unexpectedError: {
            severity: NotificationSeverity.ERROR,
            message: 'Une erreur inattendue s\'est produite, veuillez réessayer ou contacter le support si elle persiste'
        },
        passwordNotMatch: {
            severity: NotificationSeverity.ERROR,
            message: 'Le mot de passe que vous avez saisi ne correspond pas à nos enregistrements'
        },
        ...
        resourceNotFound: {
            severity: NotificationSeverity.ERROR,
            message: 'Nous n\'avons pas pu localiser la ressource que vous essayez de supprimer'
        },
        deleteActionNotPermitted: {
            severity: NotificationSeverity.ERROR,
            message: 'Vous ne disposez pas de privilèges suffisants pour supprimer la ressource en question'
        },
        deleteActionSuccess: {
            severity: NotificationSeverity.SUCCESS,
        ...
        emailAlreadyExists: {
            ...
            message: 'L\'e-mail que vous avez saisi est déjà associé à un autre utilisateur de tandeem'
        },
        adminAddedSuccess: {
            severity: NotificationSeverity.SUCCESS,
        ...
        adminPasswordResetSuccess: {
            severity: NotificationSeverity.SUCCESS,
            message: 'Le mot de passe de l\'administrateur a été réinitialisé avec succès, un email a été envoyé à son adresse email'
        },
        ...
        customerNotFound: {
            severity: NotificationSeverity.ERROR,
            message: 'Nous n\'avons pas pu localiser le client demandé dans nos enregistrements'
        },
        ...
        employeePasswordResetSuccess: {
            severity: NotificationSeverity.SUCCESS,
            message: 'Le mot de passe du salarié a été réinitialisé avec succès, un email a été envoyé à son adresse email'
        },
        mediaAddedSuccess: {
            severity: NotificationSeverity.SUCCESS,
        ...
        offerAcceptedSuccess: {
            severity: NotificationSeverity.SUCCESS,
            message: 'L\'offre a été acceptée avec succès, elle est désormais disponible pour vos collaborateurs'
        },
        offerUnacceptedSuccess: {
            severity: NotificationSeverity.SUCCESS,
            message: 'L\'offre a été des-acceptée avec succès, elle n\'est plus disponible pour vos collaborateurs'
        },
        offerDisabledSuccess: {
            severity: NotificationSeverity.SUCCESS,
            message: 'L\'offre a été désactivée avec succès, elle ne sera plus disponible pour personne'
        },
        offerEnabledSuccess: {
            severity: NotificationSeverity.SUCCESS,
        ...
        partnerNotFound: {
            severity: NotificationSeverity.ERROR,
            message: 'Nous n\'avons pas pu localiser le partenaire demandé dans nos enregistrements'
        },
        ...
        fileTooLarge: {
            severity: NotificationSeverity.WARNING,
            message: 'Le fichier que vous avez joint dépasse 1 Mo, veuillez le compresser à l\'aide d\'un outil en ligne avant de le télécharger'
        },
        imageTooLarge: {
            severity: NotificationSeverity.WARNING,
            message: 'L\'image que vous avez joint dépasse 1 Mo, veuillez le compresser à l\'aide d\'un outil en ligne avant de le télécharger'
        },
        photoTooLarge: {
            severity: NotificationSeverity.WARNING,
            message: 'La photo que vous avez joint dépasse 1 Mo, veuillez le compresser à l\'aide d\'un outil en ligne avant de le télécharger'
        },
        emailNotFound: {
            severity: NotificationSeverity.WARNING,
            message: 'L\'e-mail que vous avez saisi n\'a aucun compte utilisateur associé'
        },
        emailNotValid: {
            severity: NotificationSeverity.WARNING,
        ...
        passwordResetSentSuccess: {
            severity: NotificationSeverity.SUCCESS,
            message: 'Un courrier contenant les détails de la réinitialisation de votre mot de passe a été envoyé à votre adresse e-mail'
        },
        passwordNotStrong: {
            severity: NotificationSeverity.WARNING,
        ...
        resetTokenExpired: {
            severity: NotificationSeverity.ERROR,
            message: 'Le jeton que nous vous avons envoyé pour réinitialiser votre mot de passe a expiré'
        },
        resetTokenInvalid: {
            severity: NotificationSeverity.ERROR,
        ...
        maxEmployeesExceeded: {
            severity: NotificationSeverity.ERROR,
            message: 'Vous avez déjà atteint le nombre maximum de salariés, vous ne pouvez pas en ajouter un nouveau.'
        }
    ...
    subCategory: {
        ...
        [SubCategory.CultureAndEntertainment_ArtExhibitions]: 'Expositions artistiques',
        ...
        [SubCategory.Technology_ComputersAndAccessories]: 'Ordinateurs et accessoires',
        ...
        [SubCategory.Mobility_ChauffeuredTransport]: 'Véhicule de Transport avec Chauffeur',
        ...
        [SubCategory.FashionAndAccessories_FashionAccessories]: 'Accessoires de mode',
        ...
        [SubCategory.PressAndMagazines_MagazineSubscriptions]: 'Abonnements à des magazines',
